...
import ru.erp.sfsb.repository.repos.CutterToolEntityRepository;
...
@Slf4j
@Transactional
public class CutterToolServiceImpl extends AbstractService<CutterToolDto, CutterTool, CutterToolEntityRepository, CutterToolMapper>
        implements CutterToolService {

    public CutterToolServiceImpl(CutterToolMapper mapper, CutterToolEntityRepository repository) {
